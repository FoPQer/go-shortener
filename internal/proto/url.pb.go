...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_internal_proto_url_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserURLsResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_url_proto_rawDescGZIP(), []int{4}
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_internal_proto_url_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*URLData) Descriptor() ([]byte, []int) {
	return file_internal_proto_url_proto_rawDescGZIP(), []int{5}
}
...
const file_internal_proto_url_proto_rawDesc = "" +
	"\n" +
	"\x18internal/proto/url.proto\x12\x05proto\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x17.proto.UserURLsResponseB/Z-github.com/FoPQer/go-shortener/internal/protob\x06proto3"
...
var file_internal_proto_url_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
